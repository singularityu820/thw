...
from dl.models import lr_scheduler as lr_scheduler
from dl.utils import get_root_logger
from dl.utils.dist_util import master_only
...
class BaseModel:
    ...
    def setup_schedulers(self):
        ...
        elif scheduler_type == "ExponentialStepLR":
            for optimizer in self.optimizers:
                self.schedulers.append(
                    lr_scheduler.ExponentialStepLR(optimizer, **train_opt["scheduler"])
                )
        else:
